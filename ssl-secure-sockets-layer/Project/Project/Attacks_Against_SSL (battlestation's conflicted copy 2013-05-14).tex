...
What all these different attacks have in common is that they all are capable of silently decrypting browser cookies used to log in to websites. And obviously this may be a real threat against users of websites which are securing their communication with SSL/TLS.